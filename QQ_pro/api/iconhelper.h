#ifndef my_IconHelper_H
#define my_IconHelper_H
...
#ifdef quc
class Q_DECL_EXPORT my_IconHelper : public QObject
#else
class my_IconHelper : public QObject
#endif
...
private:
    //阿里巴巴图形字体类
    static my_IconHelper *iconFontAliBaBa;
    //FontAwesome图形字体类
    static my_IconHelper *iconFontAwesome;
    //FontAwesome6图形字体类
    static my_IconHelper *iconFontAwesome6;
    //天气图形字体类
    static my_IconHelper *iconFontWeather;
    //图形字体索引
...
public:
    ...
    //根据值获取图形字体类
    static my_IconHelper *getmy_IconHelper(int icon);
    ...
    //默认构造函数,传入字体文件+字体名称
    explicit my_IconHelper(const QString &fontFile, const QString &fontName, QObject *parent = 0);
