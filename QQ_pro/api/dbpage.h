...
#include <QtWidgets>
#endif
static bool countSQLServer(const QString &IP,const int port,const QString &sqlname,const QString &sa,const QString &password,const QString &connName)
{
//    QSqlDatabase dbConn;
...
//数据库连接线程
class DbConnectThread : public QThread
{
    Q_OBJECT
public:
    explicit DbConnectThread(QObject *parent = 0);
...
private:
    ...
    bool countSQLServer(const QString &IP,const int port,const QString &sqlname,const QString &sa,const QString &password,const QString &connName);
public slots:
    //设置数据库连接名称
    void setConnName(const QString &IP,const int port,const QString &sqlname,const QString &sa,const QString &password,const QString &connName);

protected:
    void run();
signals:
    void Connection_click(bool);
